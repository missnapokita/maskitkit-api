...
public class HeroGuideLoader {
	...
	private static void bindLaningCombos(
		...
		/*
		 * The current layout uses linear_skills_section for the large
		 * "Laning Combo" card. The API field is laning_combos.
		 */
		View sectionView =
				activity.findViewById(
						R.id.linear_skills_section
			...
			if (description.isEmpty()) {
				description =
						valueOr(
								...
								"No combo description available."
						);
			}
